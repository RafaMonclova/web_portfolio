...
# docker exec -it portfolio_celery pip uninstall channels -y
# docker exec -it portfolio_celery pip uninstall daphne -y
# docker exec -it portfolio_celery pip install -U channels["daphne"]
